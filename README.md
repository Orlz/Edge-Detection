...
There are 2 scripts included in this assignment, which can be found in the src folder

___Part One___

**edge_detection.py**  This is the original script for conducting edge detection on the Jefferson monument 


The image is saved as "weholdtruths.jpeg" in the Images folder. It can also be downloaded by the user from [here](https://upload.wikimedia.org/wikipedia/commons/f/f4/%22We_Hold_These_Truths%22_at_Jefferson_Memorial_IMG_4729.JPG)

___Part Two___

**ROI_detector.py**  This is the exploratory extension script 

The script conducts EAST text detection to see how easily a neural network would be able to pick up the text region of interest in images of graffiti. The 6 images used include the cultural graffiti collection descibed above, as well as the original image of the assignment. Full details of how the detector work can be found in the script itself.
...
___Output will be saved in the folder called Output___
...
___Recommended edge inputs for ROI of Jefferson Monument___ 
x1 = 1400
y1 = 890 
